...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"LIST_PRODUCT_BLOCKS_ALL_ORDER" => "order,desc,sale,char,projects,faq,docs,video,gallery,services,goods,comments",
		"T_CHARACTERISTICS" => "",
		"T_FAQ" => "",
		"T_DESC" => "",
		"LIST_PRODUCT_BLOCKS_ORDER" => "order,sale,tab,gallery,services,reviews,news,staff,goods,articles,study,docs,comments",
